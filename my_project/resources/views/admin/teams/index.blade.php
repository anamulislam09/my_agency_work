...
@section('admin_content')
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('member.create') }}" class="btn btn-sm btn-primary" style="float:right">Add New</a>
                        ...
                        @foreach ($datas as $key => $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('member.destroy', $data->id) }}"
    ...
    <script>
        $('body').on('click', '.edit', function() {
            ...
            $.get("team-members/edit/" + member_id, function(data) {
