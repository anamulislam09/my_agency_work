...
<section class="vs-hero-wrapper position-relative  ">
    <div class="vs-hero-carousel" data-height="850" data-container="1900" data-slidertype="responsive">
        ...
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
            <img width="1920" height="850" src="{{ asset('frontend/assets/img/hero/hero-1-1.jpg" class="ls-bg" alt="hero-bg')}}" />
        ...
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:out; kenburnsscale:1.1;">
            <img width="1920" height="850" src="{{ asset('frontend/assets/img/hero/hero-1-2.jpg" class="ls-bg" alt="hero-bg')}}" />
            <div style="font-size:36px; color:#000; text-align:left; font-style:normal; text-decoration:none; text-transform:none; font-weight:400; letter-spacing:0px; border-style:solid; border-color:#000; background-position:0% 0%; background-repeat:no-repeat; width:300px; height:1558px; background-color:rgba(14, 84, 245, 0.5); top:-473px; left:51px;" class="ls-l ls-text-layer d-hd-none" data-ls="offsetxin:-800; offsetyin:-800; durationin:1700; delayin:1200; easingin:easeOutQuint; rotatein:43.46; offsetxout:1200; offsetyout:1200; durationout:8000; startatout:slidechangeonly + 3000; easingout:easeOutQuint; scaleyout:5; rotation:43.46;"></div>
            <div style="font-size:36px; color:#000; text-align:left; font-style:normal; text-decoration:none; text-transform:none; font-weight:400; letter-spacing:0px; border-style:solid; border-color:#000; background-position:0% 0%; background-repeat:no-repeat; width:589px; height:1819.7px; top:-485px; left:406px; background:linear-gradient(172deg, rgba(5, 26, 79, 0.35) 21%, rgba(0, 0, 0, 0) 54%);" class="ls-l ls-text-layer d-hd-none" data-ls="offsetxin:-800; offsetyin:-800; durationin:1500; delayin:1300; easingin:easeOutQuint; rotatein:43.46; offsetxout:1200; offsetyout:1200; durationout:8000; startatout:slidechangeonly + 3000; easingout:easeOutQuint; scaleyout:5; bgcolorout:transparent; colorout:transparent; rotation:43.46;"></div>
        ...
        <!-- Slide 3-->
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
            <img width="1920" height="850" src="{{ asset('frontend/assets/img/hero/hero-1-3.jpg')}}" class="ls-bg" alt="hero-bg" />
            <div style="font-size:36px; color:#000; text-align:left; font-style:normal; text-decoration:none; text-transform:none; font-weight:400; letter-spacing:0px; border-style:solid; border-color:#000; background-position:0% 0%; background-repeat:no-repeat; width:300px; height:1558px; background-color:rgba(14, 84, 245, 0.5); top:-473px; left:51px;" class="ls-l ls-text-layer d-hd-none" data-ls="offsetxin:-800; offsetyin:-800; durationin:1700; delayin:1200; easingin:easeOutQuint; rotatein:43.46; offsetxout:1200; offsetyout:1200; durationout:8000; startatout:slidechangeonly + 3000; easingout:easeOutQuint; scaleyout:5; rotation:43.46;"></div>
            <div style="font-size:36px; color:#000; text-align:left; font-style:normal; text-decoration:none; text-transform:none; font-weight:400; letter-spacing:0px; border-style:solid; border-color:#000; background-position:0% 0%; background-repeat:no-repeat; width:589px; height:1819.7px; top:-485px; left:406px; background:linear-gradient(172deg, rgba(5, 26, 79, 0.35) 21%, rgba(0, 0, 0, 0) 54%);" class="ls-l ls-text-layer d-hd-none" data-ls="offsetxin:-800; offsetyin:-800; durationin:1500; delayin:1300; easingin:easeOutQuint; rotatein:43.46; offsetxout:1200; offsetyout:1200; durationout:8000; startatout:slidechangeonly + 3000; easingout:easeOutQuint; scaleyout:5; bgcolorout:transparent; colorout:transparent; rotation:43.46;"></div>
...
<div data-bg-src="{{ asset('frontend/assets/img/bg/ab-bg-1-1.jpg')}}">
    <!--==============================
Features Area
==============================-->
            ...
            <div class="row vs-carousel" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2">
                <div class="col-xl-4">
                    <div class="feature-style1">
                        <div class="feature-icon"><img src="{{ asset('frontend/assets/img/icon/fe-1-1.png')}}" alt="Features"></div>
                        <h3 class="feature-title h5"><a class="text-inherit" href="service-details.html">Development Services</a></h3>
                        <p class="feature-text">Completely implement via highly efficient process improvements. engage high value before progressive data.</p>
                        <a href="service-details.html" class="vs-btn style3">Read More<i class="far fa-long-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="feature-style1">
                        <div class="feature-icon"><img src="{{ asset('frontend/assets/img/icon/fe-1-2.png')}}" alt="Features"></div>
                ...
                <div class="col-xl-4">
                    <div class="feature-style1">
                        <div class="feature-icon"><img src="{{ asset('frontend/assets/img/icon/fe-1-3.png')}}" alt="Features"></div>
        ...
        <div class="container z-index-common">
            <div class="row gx-60">
                <div class="col-lg-6 col-xl-5 mb-50 mb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="img-box1">
                        <div class="img-1">
                            <img src="{{ asset('frontend/assets/img/about/ab-1-1.jpg')}}" alt="About image">
                        </div>
                        <div class="img-2">
                            <img src="{{ asset('frontend/assets/img/about/ab-1-2.jpg')}}" alt="About image">
                ...
                <div class="col-lg-6 col-xl-7 align-self-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="call-media">
                        <div class="call-media__icon"><img src="{{ asset('frontend/assets/img/icon/tel-1-1.png')}}" alt="icon"></div>
...
Service Area
==============================-->
<section class=" space-top space-extra-bottom" data-bg-src="{{ asset('frontend/assets/img/bg/sr-bg-1-1.png')}}">
    <div class="container">
        ...
        <div class="row wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="service-style1">
                    <div class="service-bg" data-bg-src="{{ asset('frontend/assets/img/bg/sr-box-bg-1.jpg')}}"></div>
                    <div class="service-icon"><img src="{{ asset('frontend/assets/img/icon/sr-icon-1-5.png')}}" alt="Features"></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="service-style1">
                    <div class="service-bg" data-bg-src="{{ asset('frontend/assets/img/bg/sr-box-bg-1.jpg')}}"></div>
                    <div class="service-icon"><img src="{{ asset('frontend/assets/img/icon/sr-icon-1-6.png')}}" alt="Features"></div>
...
<div class="position-relative ">
    ...
    <div class="bg-black z-index-common space" data-bg-src="{{ asset('frontend/assets/img/bg/counter-bg-1-1.jpg')}}">
        <div class="container wow fadeInUp" data-wow-delay="0.2s">
            <div class="row justify-content-between gy-4">
                <div class="col-6 col-lg-auto">
                    <div class="counter-media">
                        <div class="counter-media__icon"><img src="{{ asset('frontend/assets/img/icon/count-1-1.png')}}" alt="icon"></div>
                        <div class="media-body">
                ...
                <div class="col-6 col-lg-auto">
                    <div class="counter-media">
                        <div class="counter-media__icon"><img src="{{ asset('frontend/assets/img/icon/count-1-2.png')}}" alt="icon"></div>
                        <div class="media-body">
                ...
                <div class="col-6 col-lg-auto">
                    <div class="counter-media">
                        <div class="counter-media__icon"><img src="{{ asset('frontend/assets/img/icon/count-1-3.png')}}" alt="icon"></div>
                        <div class="media-body">
                ...
                <div class="col-6 col-lg-auto">
                    <div class="counter-media">
                        <div class="counter-media__icon"><img src="{{ asset('frontend/assets/img/icon/count-1-4.png')}}" alt="icon"></div>
                        <div class="media-body">
        ...
        <div class="row vs-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2">
            <div class="col-xl-3">
                <div class="team-style1">
                    <div class="team-img">
                        <a href="team-details.html"><img src="{{ asset('frontend/assets/img/team/t-1-1.jpg')}}" alt="image"></a>
                    ...
                    <div class="team-content">
                        <h3 class="team-title"><a class="text-inherit" href="team-details.html">Daniel Matthew</a></h3>
            ...
            <div class="col-xl-3">
                <div class="team-style1">
                    <div class="team-img">
                        <a href="team-details.html"><img src="{{ asset('frontend/assets/img/team/t-1-2.jpg')}}" alt="image"></a>
                        <div class="team-social">
                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="team-content">
                        <h3 class="team-title"><a class="text-inherit" href="team-details.html">Grayson Gabriel</a></h3>
            ...
            <div class="col-xl-3">
                <div class="team-style1">
                    <div class="team-img">
                        <a href="team-details.html"><img src="{{ asset('frontend/assets/img/team/t-1-3.jpg')}}" alt="image"></a>
                        <div class="team-social">
                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="team-content">
                        <h3 class="team-title"><a class="text-inherit" href="team-details.html">Alexander Mason</a></h3>
            ...
            <div class="col-xl-3">
                <div class="team-style1">
                    <div class="team-img">
                        <a href="team-details.html"><img src="{{ asset('frontend/assets/img/team/t-1-4.jpg')}}" alt="image"></a>
                        <div class="team-social">
                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="team-content">
                        <h3 class="team-title"><a class="text-inherit" href="team-details.html">Maverick Cameron</a></h3>
            ...
            <div class="col-xl-3">
                <div class="team-style1">
                    <div class="team-img">
                        <a href="team-details.html"><img src="{{ asset('frontend/assets/img/team/t-1-5.jpg')}}" alt="image"></a>
                        <div class="team-social">
                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-instagram"></i></a>
                    ...
                    <div class="team-content">
                        <h3 class="team-title"><a class="text-inherit" href="team-details.html">Marian Widjya</a></h3>
...
<section class="faq-wrap1  ">
    <div class="faq-shape1" data-bg-src="{{ asset('frontend/assets/img/bg/faq-bg-1-1.jpg')}}"></div>
    <div class="faq-shape2" data-bg-src="{{ asset('frontend/assets/img/bg/faq-bg-1-2.jpg')}}"></div>
    <div class="container">
        <div class="row gx-60">
            <div class="col-lg-6 pb-20 pb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                <div class="img-box2">
                    <div class="img-1"><img src="{{ asset('frontend/assets/img/faq/faq-1-1.jpg')}}" alt="FAQ image"></div>
                    <div class="img-2"><img src="{{ asset('frontend/assets/img/faq/faq-1-2.jpg')}}" alt="FAQ image"><a class="play-btn style3 position-center" href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"><i class=""><i class="fas fa-play"></i></i></a></div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-5 col-xxl-auto mb-30 pb-20 pb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                <img src="{{ asset('frontend/assets/img/skill/skill-1-1.jpg')}}" alt="Skill image">
            </div>
...
CTA Area
==============================-->
<section class="z-index-common space" data-bg-src="{{ asset('frontend/assets/img/bg/cta-bg-1-1.jpg')}}">
    <div class="container">
...
Work Process
==============================-->
<section class=" space-top space-extra-bottom" data-bg-src="{{ asset('frontend/assets/img/bg/process-bg-1-1.jpg')}}" id="processv1">
    <div class="container wow fadeInUp" data-wow-delay="0.2s">
        <div class="row justify-content-center text-center">
            <div class="col-xl-6">
                <div class="title-area">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 process-style1">
                <div class="process-arrow"><img src="{{ asset('frontend/assets/img/icon/process-arrow-1-1.png')}}" alt="arrow"></div>
                <div class="process-icon">
                    <img src="{{ asset('frontend/assets/img/icon/process-1-4.png')}}" alt="icon">
                    <span class="process-number">01</span>
                </div>
                <h3 class="process-title h5">Medicine Help</h3>
                <p class="process-text">Extensible for web iterate process before meta services impact with olisticly enable client.</p>
            </div>
            <div class="col-sm-6 col-lg-3 process-style1">
                <div class="process-arrow"><img src="{{ asset('frontend/assets/img/icon/process-arrow-1-1.png')}}" alt="arrow"></div>
                <div class="process-icon">
                    <img src="{{ asset('frontend/assets/img/icon/process-1-1.png')}}" alt="icon">
                    <span class="process-number">01</span>
                </div>
            ...
            <div class="col-sm-6 col-lg-3 process-style1">
                <div class="process-arrow"><img src="{{ asset('frontend/assets/img/icon/process-arrow-1-1.png')}}" alt="arrow"></div>
                <div class="process-icon">
                    <img src="{{ asset('frontend/assets/img/icon/process-1-2.png')}}" alt="icon">
                    <span class="process-number">01</span>
                </div>
            ...
            <div class="col-sm-6 col-lg-3 process-style1">
                <div class="process-arrow"><img src="{{ asset('frontend/assets/img/icon/process-arrow-1-1.png')}}" alt="arrow"></div>
                <div class="process-icon">
                    <img src="{{ asset('frontend/assets/img/icon/process-1-3.png')}}" alt="icon">
                    <span class="process-number">01</span>
                </div>
...
<section class=" space-bottom">
    <div class="container">
        ...
        <div class="row vs-carousel text-center" data-slide-show="5" data-md-slide-show="3" data-sm-slide-show="2" data-xs-slide-show="2">
            <div class="col-auto"><img src="{{ asset('frontend/assets/img/brand/br-1-1.png')}}" alt="Brand"></div>
            <div class="col-auto"><img src="{{ asset('frontend/assets/img/brand/br-1-2.png')}}" alt="Brand"></div>
            <div class="col-auto"><img src="{{ asset('frontend/assets/img/brand/br-1-3.png')}}" alt="Brand"></div>
            <div class="col-auto"><img src="{{ asset('frontend/assets/img/brand/br-1-4.png')}}" alt="Brand"></div>
            <div class="col-auto"><img src="{{ asset('frontend/assets/img/brand/br-1-5.png')}}" alt="Brand"></div>
            <div class="col-auto"><img src="{{ asset('frontend/assets/img/brand/br-1-6.png')}}" alt="Brand"></div>
        </div>
    </div>
</section>
<!--==============================
Blog Area
==============================-->
<section class="vs-blog-wrapper  space-top space-extra-bottom" data-bg-src="{{ asset('frontend/assets/img/bg/blog-bg-1-1.jpg')}}">
    <div class="container  wow fadeInUp" data-wow-delay="0.2s">
        <div class="row justify-content-center text-center">
            <div class="col-xl-6">
                <div class="title-area">
