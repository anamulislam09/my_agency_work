...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        ...
                        <h3 class="service-title h5"><a href="service-details.html">{{$item->service_name }}</a></h3>
                        <p class="service-text">{{$item->service_details}}</p>
    ...
    Work Process
    ==============================-->
    <section class="process-wrap1 space-top space-extra-bottom" data-bg-src="{{asset('frontend/assets/img/bg/process-bg-3-1.jpg')}}">
        <div class="container   wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="row justify-content-between">
                <div class="col-md-4 col-xl-auto process-style2">
                    <div class="process-arrow"><img src="{{asset('frontend/assets/img/icon/process-arrow-2-1.png')}}" alt="arrow"></div>
